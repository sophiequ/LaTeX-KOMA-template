...
%doc% \begin{document}
%doc% %% title page %%
%doc% \title{\THSinserttitle}\subtitle{\THSinsertsubject}
%doc% \author{\THSinsertauthor}
%doc% \date{\today}
%doc% 
%doc% \maketitle\newpage
%doc% 
...
%doc% 
\usepackage[\THS@language]{babel}  %% used languages; default language is *last* language of options
...
style=\THS@biblatexstyle, %% see biblatex documentation
%style=alphabetic, %% see biblatex documentation
dashed=\THS@biblatexdashed, %% do *not* replace recurring reference authors with a dash
backref=\THS@biblatexbackref, %% create backlings from references to citations
natbib=true, %% offering natbib-compatible commands
hyperref=true, %% using hyperref-package references
]{biblatex}  %% remove, if using BibTeX instead of biblatex

\addbibresource{\THS@biblatexfile} %% remove, if using BibTeX instead of biblatex
...
\def\mycolor{\THS@dispositioncolor}
% \show\THS@language
% \show\THS@dispositioncolor
...
\usepackage[\THS@todonotesoptions]{todonotes}  %% option "disable" removes all todonotes output from resulting document
